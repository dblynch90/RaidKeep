              ...
              <div className="px-7 py-6 sm:px-9 sm:py-7">
                ...
                <div className="mb-7 w-full max-w-[308px] mx-auto space-y-4">
                  <a
                    ...
                    className="flex items-center justify-center w-full min-h-[48px] py-3.5 px-5 rounded-lg bg-[#148EFF] hover:bg-[#148EFF]/90 !text-white font-bold text-base sm:text-lg transition shadow-lg shadow-blue-900/20 whitespace-nowrap"
                  >
